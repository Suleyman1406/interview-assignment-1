...
const Navbar = () => {
  return (
    <div className="h-30 md:h-20 py-5 shadow-2xl duration-300 flex flex-col justify-center items-center md:items-stretch md:flex-row md:justify-between px-5">
